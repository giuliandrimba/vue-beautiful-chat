      ...
      <div class="sc-message--toolbox" :style="{background: messageColors.backgroundColor}">
        ...
        >
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            width="12px" height="12px" viewBox="146 146 18 18" enable-background="new 146 146 18 18" xml:space="preserve">
              <path fill="#FFFFFF" d="M154.405,151.001h-1.681v-2.802c0-0.232-0.142-0.439-0.357-0.523c-0.215-0.083-0.461-0.025-0.617,0.147l-5.603,6.164
